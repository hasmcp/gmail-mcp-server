...
- [sendEmail](gmail/gmail/tools/send-email.md) — Send new email or reply to thread
- [searchEmails](gmail/gmail/tools/search-emails.md) — Search for emails. Use 'q' for query (e.g. 'from:alice')
- [readEmailSnippet](gmail/gmail/tools/read-email-snippet.md) — Read initial part of the email content along with email headers.
